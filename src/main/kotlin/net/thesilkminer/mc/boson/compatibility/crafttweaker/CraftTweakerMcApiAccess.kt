...
fun ItemStack.toZen(wildcard: Boolean = false) = findMethod(if (wildcard) "getIItemStackWildcardSize" else "getIItemStack", ItemStack::class).call<IItemStack?>(this)
...
fun IBlockAccess.findZenBlockAt(x: Int, y: Int, z: Int) = findMethod("getBlock", IBlockAccess::class, Int::class, Int::class, Int::class).call<IBlock>(this, x, y, z)
...
fun net.minecraft.command.ICommandSender?.toZen() = findMethod("getICommandSender", net.minecraft.command.ICommandSender::class).call<ICommandSender?>(this)
